...
public class LibrarySystem {
    ...
    public static void main(String[] args) {
        buku.add(new Book("001", "Indonesia Ku", "liliam", "Sejarah", 4));
        buku.add(new Book("002", "pahlawan Bangsa", "Farid", "Sejarah", 2));
        buku.add(new Book("003", "Anak Bangsa", "Albert", "Sejarah", 1));

        mahasiswa.add(new Student("202210370311209", "Aldela kurniawati", "Informatika"));
        mahasiswa.add(new Student("202210370311300", "Cahya Sukma Karmila", "Informatika"));
        mahasiswa.add(new Student("202210370311307", "Dwi Qatrunnada", "Informatika"));
    ...
    private static void loginSebagaiAdmin(Scanner scanner) {
        ...
        System.out.println("2. Tampilkan Mahasiswa Yang Terdaftar");
